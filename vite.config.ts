...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ["pharma-logo.png"],
      manifest: {
        name: "Pharma GCC Transformation Handbook",
        short_name: "Pharma Handbook",
        description: "A definitive guide to pharmaceutical GCC transformation in the AI era.",
        theme_color: "#0A1628",
