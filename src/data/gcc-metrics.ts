...
export const gccMetrics: GccMetric[] = [
  ...
  { metric: "Gender Diversity Ratio", dimension: "Future-Ready Workforce", description: "% women in overall workforce and in leadership", matureBenchmark: ">40% workforce; >30% leadership", largeBenchmark: "35–40% workforce; 20–30% leadership", industryInsight: "Pharma GCCs are among the most gender-balanced in the GCC landscape; DEI is a measurable talent-brand and retention lever", source: "NASSCOM / Zinnov" },
  { metric: "Cyber Resilience Maturity", dimension: "Risk & Resilience", description: "Security posture across NIST CSF / ISO 27001 controls and incident readiness", matureBenchmark: "NIST CSF Tier 3–4; <24h detection; global SecOps owned", largeBenchmark: "Tier 2–3; defined SOC and playbooks", industryInsight: "Pharma is a high-value cyber target; mature GCCs increasingly own enterprise security operations and threat intelligence", source: "KPMG / Industry" },
  { metric: "Innovation Reinvestment Rate", dimension: "Value & Cost", description: "% of run-cost/arbitrage savings redeployed into new capability and innovation", matureBenchmark: ">30% of savings reinvested", largeBenchmark: "15–25% reinvested", industryInsight: "Leading GCCs recycle cost-arbitrage savings into AI, automation, and platform build — funding the shift from cost centre to value centre", source: "BCG / Zinnov" },
];
