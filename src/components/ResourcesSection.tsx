...
const resources: (ResourceFile & { primary?: boolean })[] = [
  {
    ...
    size: "~0.9 MB",
    description: "The single source of truth, refreshed 2026. Self-contained HTML with sidebar navigation, 47 SVG diagrams, search, reading progress, and all 30 chapters across 9 parts.",
    primary: true,
  },
  {
    ...
    type: "pdf",
    size: "~3.6 MB",
    description: "Complete 246-page PDF edition, regenerated from the 2026-refreshed content — all 30 chapters with diagrams, tables, and regional spotlights. Ideal for printing and formal distribution.",
  },
  {
