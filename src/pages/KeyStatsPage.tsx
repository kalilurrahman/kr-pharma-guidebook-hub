...
const stats: StatCard[] = [
  ...
  { value: "20–25%", label: "Field Force Productivity Gain (AI)", interpretation: "AI-driven next-best-action engines and territory optimisation boost rep productivity by up to 25%. Novartis reported $200M in annual gains.", chapter: "Ch 9 · Commercial Excellence", chapterAnchor: "ch09", category: "commercial" },
  { value: "$200M", label: "Novartis Annual AI Sales Gains", interpretation: "Novartis's deployment of AI-driven commercial analytics across its sales force generated $200M in measurable annual value.", chapter: "Ch 9 · Commercial Excellence", chapterAnchor: "ch09", category: "commercial" },
