...
const stats: StatCard[] = [
  ...
  { value: "200M+", label: "AlphaFold Protein Structures", interpretation: "DeepMind's AlphaFold Protein Structure Database covers 200M+ predicted structures — virtually all catalogued proteins — transforming target identification and structure-based drug design.", chapter: "Ch 4 · R&D & Drug Discovery", chapterAnchor: "ch04", category: "rnd" },
  ...
  { value: "1,600+", label: "GCCs in India (All Sectors)", interpretation: "India hosts the world's largest GCC ecosystem (~1,600+ across all industries, 1.9M+ employees). Of these, 30+ are dedicated pharma GCCs increasingly leveraged for AI, analytics, and digital transformation.", chapter: "Ch 16 · Pharma GCCs in India", chapterAnchor: "ch16", category: "digital" },
